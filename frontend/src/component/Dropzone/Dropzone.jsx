...
export default function MyDropzone() {
  ...
  return (
    <div className="flex flex-col w-full justify-center items-center mt-12 mb-12">
      ...
      <Button color="primary" className="mt-4" type="submit" onClick={handleUploadFile} isDisabled={isUploading}>
        {isUploading ? "Uploading..." : "Save File to Database"}
      </Button>
